        ...
        <div>
            <div id="sidenav">
                ...
                <a href="https://vk.com/radiomipt" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 445 445" height="33"><title>Вконтакте</title>
                ...
                <a href="https://twitter.com/radiomipt" target="_blank" rel="noreferrer">
                    <img width="49" height="49" src="../../public/img/twitter.png" alt={"Twitter"}/>
                </a>
            </div>
            <div id="nav-icon">
                <span/>
            ...
            <div id="main">
                <div id="welcome">
                    <img id="logo-image" src="img/logo-image.svg"  alt={"radio.mipt logo"}/>
                    <img id="logo-text" src="img/logo-text.svg" alt={"radio.mipt name"}/>
                    <svg id="arrow">
                        <g>
                            <path
                                d="M 19.208,18.592c-0.241,0-0.483-0.087-0.673-0.261
                                   L 0.327,1.74c-0.408-0.372-0.438-1.004-0.066-1.413
                                   c 0.372-0.409,1.004-0.439,1.413-0.066L19.208,16.24
                                   L 36.743,0.261c0.411-0.372,1.042-0.342,1.413,0.066
                                   c 0.372,0.408,0.343,1.041-0.065,1.413L19.881,18.332
                                   C 19.691,18.505,19.449,18.592,19.208,18.592
                                   z"
                            />
                        </g>
                    </svg>
